...
export const EVENT_ROUTES: Record<HimsEventType, EventRoute> = {
  ...
  'patient.identifier.linked': {
    queue: Q.EMR,
    job: HIMS_JOB_NAMES[Q.EMR].PROJECT,
    expedite: false,
  },
  ...
  'opd.appointment.created': {
    queue: Q.REMINDERS,
    job: HIMS_JOB_NAMES[Q.REMINDERS].SCAN,
    expedite: false,
  },
  ...
  'opd.appointment.checked_in': {
    queue: Q.ANALYTICS,
    job: HIMS_JOB_NAMES[Q.ANALYTICS].INGEST,
    expedite: false,
  },
  ...
  'ipd.discharge.summary.finalized': {
    queue: Q.REPORTS,
    job: HIMS_JOB_NAMES[Q.REPORTS].GENERATE,
    expedite: false,
  },
  ...
  'lab.specimen.rejected': {
    ...
    job: HIMS_JOB_NAMES[Q.NOTIFICATIONS].DISPATCH,
    expedite: true,
  },
  ...
  'billing.payment.created': {
    queue: Q.INTEGRATION,
    job: HIMS_JOB_NAMES[Q.INTEGRATION].DELIVER,
    expedite: true,
  },
  ...
  'document.created': {
    queue: Q.DOCUMENTS,
    job: HIMS_JOB_NAMES[Q.DOCUMENTS].PROCESS,
    expedite: false,
  },
  'document.uploaded': {
    queue: Q.DOCUMENTS,
...
export function routeEvent(eventType: string): EventRoute | null {
  return isHimsEventType(eventType) ? EVENT_ROUTES[eventType] : null;
}

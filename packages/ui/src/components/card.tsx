 ...
 * React 19 no longer injects `props.children` implicitly for the a11y linter to
 * see, and a heading whose content cannot be determined statically is reported

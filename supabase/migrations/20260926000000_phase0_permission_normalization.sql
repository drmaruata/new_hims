...
WHERE r.code = 'ADMIN'
  AND p.code IN (
    'PLATFORM:TENANT:READ:TENANT','PLATFORM:TENANT:UPDATE:TENANT',
    'PLATFORM:FACILITY:READ:TENANT','PLATFORM:FACILITY:CREATE:TENANT',
    'PLATFORM:FACILITY:READ:FACILITY','PLATFORM:FACILITY:UPDATE:FACILITY',
    'PLATFORM:DEPARTMENT:READ:TENANT','PLATFORM:DEPARTMENT:CREATE:TENANT',
    'PLATFORM:DEPARTMENT:READ:FACILITY','PLATFORM:DEPARTMENT:UPDATE:FACILITY',
    'PLATFORM:LOCATION:READ:FACILITY','PLATFORM:USER:READ:TENANT',
    'PLATFORM:USER:UPDATE:TENANT','PLATFORM:ROLE:READ:TENANT',
    'PLATFORM:ROLE:CREATE:TENANT','PLATFORM:ROLE:UPDATE:TENANT',
    'SYSTEM:AUDIT:READ:TENANT','SYSTEM:USER:MANAGE:TENANT',
    'SYSTEM:ROLE:MANAGE:TENANT','SYSTEM:FACILITY:MANAGE:TENANT',
    'SYSTEM:DEPARTMENT:MANAGE:FACILITY','SYSTEM:INTEGRATION:MANAGE:TENANT',
